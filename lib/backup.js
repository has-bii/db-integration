          ...
          try {
            ...
            if (sql.type === "read & write") {
              ...
              if (!isLastDataExists) {
                ...
                const results = await source_db.query(getQuery, {
                  type: QueryTypes.SELECT,
                })
                ...
                if (isTableEmpty) {
                  ...
                  data = await source_db.query(getQuery, {
                    type: QueryTypes.SELECT,
                  })
                } else {
                  ...
                  // data = await source_db.query(getDataQuery, {})
                }

                console.log("\nRetrieved Rows: ", data.length, "\n")

                if (data.length !== 0) {
                  const values = dataToQuery(target_db, data, query.values)
                  ...
                  console.log("\nInserted Rows: ", insertedRows)
                } else console.log("No action executed.")
              }
            }
