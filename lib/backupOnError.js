...
const { writeErrorConfig, insertToConfig } = require("./configHandler");
const backup = require("./backup");

module.exports = async () => {
  try {
    const errorConfigFilePath = process.env.ERROR_CONFIG_FILE_PATH;
    ...
    console.error(
      "An error has occurred while Backup on Error Config: ",
      error
    );
  }
};
